function output = analyse_phi_curve_high_ten_approx(ds,slice,varargin)
...
%     counter
    ...
    E = ds.delE(jj,:);
    remove_points = false(size(E));
    
    xx = linspace(0,pi,N_spline_points);
%     fprintf('here %d \n', counter);
    E_spline = fit_spline(ds.phi_vals, E, xx, remove_points, ...
...
%         plot(ds.phi_vals, L, 'k:', 'LineWidth',0.5);
%         plot(ds.phi_vals, U, 'k:', 'LineWidth',0.5);
%         yyaxis right
